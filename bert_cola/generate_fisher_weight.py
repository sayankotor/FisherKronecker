...
def training_process(path_to, size_of, lr):
    """
    ...
    print ("res AdamW", res['eval_matthews_correlation'])
    ...
    with open(os.path.join(trainer.args.output_dir, 'tensor_grad78_int.pickle'), 'wb') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--size_of', type=int, required=True,
    ...
    training_process(args.path_to, args.size_of, args.lr)